...
const HomeScreen =({navigation})=>{
    return(
        <>
            <View>
                <Video
                    source={require("/Users/justinconger/IdeaProjects/AwesomeProject/assets/Serenity.mp4")}
                ...
                <Wrapper>
                    ...
                    <ButtonWrapper>
                        <Fragment>
                            ...
                            <Button transparent title="Login" onPress={()=>{navigation.navigate('Page3')}}></Button>
                        </Fragment>
                    </ButtonWrapper>
                </Wrapper>
            </View>
